...
class Order(models.Model):
    ...
    sn = models.CharField('开单编号', max_length=20, unique=True, default=default_order_sn)

    status = models.CharField('当前状态', max_length=5)
...
class OpenOrder(models.Model):
    ...
    applicant = models.ForeignKey(UserModel, related_name='open_orders', on_delete=models.PROTECT, verbose_name='申请人')
    department = models.ManyToManyField(Group, related_name='open_orders', blank=True, verbose_name='开单部门')
    department_r = models.ManyToManyField(Group, related_name='open_orders_r', blank=True, verbose_name='责任部门')
    ...
    user_product = models.ManyToManyField(UserModel, related_name='+', blank=True, verbose_name='通知生产人员')
    user_process = models.ManyToManyField(UserModel, related_name='+', blank=True, verbose_name='通知制程人员')
